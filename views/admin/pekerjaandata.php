...
<div class="h-screen flex overflow-hidden font-[montserrat]">
    ...
    <div class="flex flex-col w-0 flex-1 overflow-hidden bg-slate-200 items-center">
        ...
        <div class="flex-1 relative z-0 overflow-y-auto focus:outline-none w-[1400px] justify-center" tabindex="0">
            ...
            <h1 class="text-[24px] ml-4 mb-4">Data Pekerjaan</h1>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 justify-start flex">
                                Pendaftar
                            </th>
                            <th scope="col" class="px-6 py-3">
                                Status
                    ...
                    <tbody>
                        ...
                        foreach ($pekerjaan as $pekerjaan_item) { ?>
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <?= $pekerjaan_item['pekerjaan']['nama_pekerjaan'] ?>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 flex justify-start">
                                    <?= $pekerjaan_item['lamarancount'] ?>
                                </td>
                                <td class="px-6 py-4">
                                    <?= $pekerjaan_item['pekerjaan']['status'] ?>
                                </td>
                                <td class="px-6 py-4 flex justify-center">
                                    <button onclick="toggleDescription(<?= $pekerjaan_item['pekerjaan']['id'] ?>)" class="font-medium text-blue-600  hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                            <path fill="currentColor" d="m12 15l-4.243-4.242l1.415-1.414L12 12.172l2.828-2.828l1.415 1.414L12 15.001Z" />
                                        </svg></button>
                                    <button onclick="editPekerjaan(<?= $pekerjaan_item['pekerjaan']['id'] ?>)" class="font-medium text-green-600 hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                    ...
                                    <button onclick="showDelButton(<?= $pekerjaan_item['pekerjaan']['id'] ?>)" class="text-red-500 hover:underline">
                            ...
                            <tr id="<?= $pekerjaan_item['pekerjaan']['id'] ?>Description" class="hidden py-4 px-4 border-t border-gray-200 bg-slate-100">
                                <td colspan="6" class="p-8">
                                    <h4 class="font-medium text-base text-[#CB6062] underline mb-2"><?= $pekerjaan_item['pekerjaan']['nama_pekerjaan'] ?></h4>
                                    <span>Alamat : </span>
                                    <p class="text-sm text-gray-600">
                                        <?= $pekerjaan_item['pekerjaan']['alamat'] ?>
                                    </p>
                                    <span>Deskripsi : </span>
                                    <p class="text-sm text-gray-600">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        <span id="waktukerja<?= $pekerjaan_item['pekerjaan']['id'] ?>"><?= $pekerjaan_item['pekerjaan']['waktu_kerja'] ?></span>
                                        -
                                        <span id="waktuselesai<?= $pekerjaan_item['pekerjaan']['id'] ?>"><?= $pekerjaan_item['pekerjaan']['waktu_selesai'] ?></span>
                                    </p>

                                    <span>Kompensasi :</span>
                                    <div class="flex flex-row gap-2">
                                        <p class="text-sm text-gray-600">Rp</p>
                                        <p id="kompensasi<?= $pekerjaan_item['pekerjaan']['id'] ?>" class="text-sm text-gray-600"><?= $pekerjaan_item['pekerjaan']['kompensasi'] ?></p>
                                        <p class="text-sm text-gray-600 capitalize">/ <?= $pekerjaan_item['pekerjaan']['per'] ?></p>
                                    </div>

                                    <span>Status Pekerjaan : </span>
                                    <p class="text-sm text-gray-600">
                                        <?php if ($pekerjaan_item['pekerjaan']['status'] == 'ongoing') {
                            ...
                            <div id="editpekerjaan<?= $pekerjaan_item['pekerjaan']['id'] ?>" class="fixed top-0 left-0 items-center justify-center hidden w-screen h-screen transition-opacity duration-500 bg-black opacity-0 bg-opacity-40">
                                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 rounded-lg shadow-lg bg-blueGray-100">
                                    ...
                                    <div class="flex-auto px-4 py-4 pt-0 lg:px-10">
                                        <form class="flex flex-col items-center justify-center" action="<?= urlpath('dashboard/pekerjaan_list/update') ?>" method="post" enctype="multipart/form-data" id="editlokerform<?= $pekerjaan_item['pekerjaan']['id'] ?>">
                                                    ...
                                                    <div class="w-full mb-3">
                                                        ...
                                                        <div class="flex flex-row justify-evenly">
                                                            <div class="flex flex-col">
                                                                ...
                                                                <input type="text" name="email" id="email0" class="w-[200px] custom-select" value="<?= htmlspecialchars($pekerjaan_item['pekerjaan']['email']) ?>" placeholder="Email">
                                                            </div>
                                                            <div class="flex flex-col">
                                                                </input><label class="flex justify-center mb-2 text-xs font-bold uppercase text-[#204E51]" htmlfor="grid-password">
                                                                    No.Telp
                                                                </label>
                                                                <input type="text" name="telp" id="telp0" class="w-[200px] custom-select" value="<?= htmlspecialchars($pekerjaan_item['pekerjaan']['telp']) ?>" placeholder="Telp">
                                                                </input>
                                                            </div>
                                                            <div class="flex flex-col">
                                                                </input><label class="flex justify-center mb-2 text-xs font-bold uppercase text-[#204E51]" htmlfor="grid-password">
                                                                ...
                                                                <input type="date" name="batas" id="batas0" class="w-[200px] custom-select" value="<?= htmlspecialchars($pekerjaan_item['pekerjaan']['batas']) ?>" placeholder="Batas Lamaran">
                                                                </input>
                                                            </div>
                                                        </div>
                                                        <div class="flex flex-row gap-8">
                                                            <div class="flex flex-col">
                                                                ...
                                                                <textarea name="deskripsi" id="deskripsi0" class="w-[500px] h-40 resize-none custom-select"><?= htmlspecialchars($pekerjaan_item['pekerjaan']['deskripsi']) ?></textarea>
                                                            </div>
                                                            <div class="flex flex-col">
                                                                <label class="block mb-2 text-xs font-bold uppercase text-[#204E51]" htmlfor="grid-password">
                                                                    Isikan Tugas
                                                                </label>
                                                                <textarea name="tugas" id="tugas0" class="w-[500px] h-40 custom-select resize-none"><?= htmlspecialchars($pekerjaan_item['pekerjaan']['tugas']) ?></textarea>
                                                            </div>
                                                        </div>
                                            ...
                                            <button type="submit" class="flex w-full justify-center rounded-[12px] bg-[#204E51] opacity-70 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#37251b] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#76f51] mt-4" form="editlokerform<?= $pekerjaan_item['pekerjaan']['id'] ?>">
                                                Simpan
                                            </button>
                                        </form>
                                    </div>
