            ...
            <div class="flex flex-row mt-4 gap-2" id="bottom-container">
                <div class="flex flex-col h-[500px] overflow-y-auto" id="pekerjaan-list">
                    <?php foreach ($pekerjaan as $pekerjaan_item) { ?>
                        ...
                        <div class="w-[300px] bg-white border border-gray-200 rounded-[4px] shadow pekerjaan-item my-1 focus:border-[#CB6062]" data-nama="<?= htmlspecialchars($pekerjaan_item['nama_pekerjaan']) ?>" data-deskripsi="<?= htmlspecialchars($pekerjaan_item['deskripsi']) ?>" data-alamat="<?= htmlspecialchars($pekerjaan_item['alamat']) ?>" data-status="<?= htmlspecialchars($pekerjaan_item['status']) ?>" data-id="<?= $pekerjaan_item['id'] ?>" data-foto="<?= htmlspecialchars($pekerjaan_item['foto']) ?>">
                    ...
                    <div class="flex flex-col h-[500px] overflow-y-auto" id="pekerjaan-list">
                        <?php foreach ($pekerjaan as $pekerjaan_item) { ?>
                            ...
                            <div class="w-[300px] bg-white border border-gray-200 rounded-[4px] shadow pekerjaan-item my-1 focus:border-[#CB6062]" data-nama="<?= htmlspecialchars($pekerjaan_item['nama_pekerjaan']) ?>" data-deskripsi="<?= htmlspecialchars($pekerjaan_item['deskripsi']) ?>" data-alamat="<?= htmlspecialchars($pekerjaan_item['alamat']) ?>" data-status="<?= htmlspecialchars($pekerjaan_item['status']) ?>" data-id="<?= $pekerjaan_item['id'] ?>" data-foto="<?= htmlspecialchars($pekerjaan_item['foto']) ?>">
                                <div class="flex flex-row">
                                    <a href="#">
                                        <img class="rounded-t-lg w-[50px]" src="<?= urlpath('uploads/foto_pekerjaan/' . $pekerjaan_item['foto']) ?>" alt="<?= htmlspecialchars($pekerjaan_item['nama_pekerjaan']) ?>" />
                                    </a>
                                    <div class="flex flex-col w-[300px]">
